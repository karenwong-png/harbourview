...
window.CONDO = {
  ...
  partnerModel: {
    eyebrow: "A Co-Living Operating Partnership",
    title: "Partner with BeLive to operate co-living at scale.",
    lead: "BeLive runs the co-living layer end-to-end — so your development absorbs faster, your buyers earn more per unit, and occupancy stays high without you managing tenants.",
    items: [
      { icon: "↑", head: "Faster absorption", body: "A co-living income story makes units easier to sell — buyers see managed, room-by-room yield, not just a place to live." },
      { icon: "%", head: "Higher per-unit yield", body: "Room-by-room + partition optimisation lifts gross yield above whole-unit renting, a concrete selling point for your buyers." },
      { icon: "◎", head: "Ready tenant pipeline", body: "BeLive fills rooms from an existing renter community across Penang, KL/Selangor and Johor — students, young professionals and industrial staff." },
      { icon: "⚙", head: "Hands-off management", body: "Smart locks, furnishing, tenant screening, rent collection and upkeep are all run by BeLive — zero operational load on you or the owners." },
      { icon: "◆", head: "Brand & standards", body: "A consistent, trusted co-living brand and fit-out standard across the development protects pricing and reputation." },
      { icon: "⤬", head: "Aligned model", body: "BeLive only wins when units are filled and yielding — our incentives sit with your absorption and your buyers' returns." }
    ]
  },
  ...
  hero: {
    eyebrow: "A Co-Living Operating Partnership",
    sub:     "Partner with BeLive to operate managed co-living across Harbour View Residence — accelerating absorption, lifting per-unit yield for your buyers, and filling units with a ready tenant pipeline.",
    stats: [
      { value: "6% – 7%",    label: "Per-Unit Gross Yield" },  // buyer sales tool — comp-backed Optimized
      { value: "373",        label: "Freehold Units" },         // scale for the operating partnership
      { value: "Grade A",    label: "Co-Living Asset (81/100)" }, // ties to scoring total
    ],
  },
